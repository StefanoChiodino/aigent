...
The first time the one presses Ctrl C, if there is already something typed, it should clear up the thing, and it should also make you have to type it twice, instead of just once, just like it would do in Open Claw. I want it to feel like a good CLI like the terminal normally would, you know what I mean?

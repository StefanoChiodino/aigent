...
test('task badge appears when a task is running', async ({ page }) => {
  await injectEvent({
    type: 'task_update',
...
test('task badge shows count for running tasks', async ({ page }) => {
  await injectEvent({
    type: 'task_update',
...
test('task badge hides when task completes', async ({ page }) => {
  await injectEvent({
    type: 'task_update',
...
test('task description appears in sidebar task list', async ({ page }) => {
...
test('running task shows running status indicator', async ({ page }) => {
  await injectEvent({
    type: 'task_update',
...
test('completed task shows completed status indicator', async ({ page }) => {
  await injectEvent({
    type: 'task_update',
...
test('failed task shows failed status indicator', async ({ page }) => {
  await injectEvent({
    type: 'task_update',
...
test('updating an existing task replaces it in the list', async ({ page }) => {
  await injectEvent({
    type: 'task_update',
...
test('multiple simultaneous running tasks show correct badge count', async ({ page }) => {
  await injectEvent({
    type: 'task_update',
...
test('user-pull completed task is clickable in sidebar', async ({ page }) => {
  await injectEvent({
    type: 'task_update',
    task: {
      id: 'tp1',
...
test('clicking user-pull task opens result panel', async ({ page }) => {
  await injectEvent({
    type: 'task_update',
    task: {
      id: 'tp2',
...
test('task result panel close button hides the panel', async ({ page }) => {
  await injectEvent({
    type: 'task_update',
    task: {
      id: 'tp3',

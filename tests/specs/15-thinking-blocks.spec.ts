...
test.describe('Thinking Blocks', () => {
  ...
  test('finalized thinking block has "done" class', async () => {
    const page = getPage();
  ...
  test('finalized thinking block toggle shows "💭 Reasoned"', async () => {
    const page = getPage();
  ...
  test('thinking body is collapsed by default after finalization', async () => {
    const page = getPage();
  ...
  test('clicking thinking toggle reveals the thinking content', async () => {
    const page = getPage();
  ...
  test('clicking thinking toggle again collapses it', async () => {
    const page = getPage();
  ...
  test('expanded thinking block adds "expanded" class to the block element', async () => {
    const page = getPage();
  ...
  test('traces summary shows "💭 reasoned" label after thinking turn', async () => {
    const page = getPage();

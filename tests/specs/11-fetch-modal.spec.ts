...
test('fetch_request shows permission modal', async ({ page }) => {
...
test('modal shows the URL in the detail area', async ({ page }) => {
...
test('modal shows the HTTP method in the detail area', async ({ page }) => {
...
test('defaults to GET when no method is specified', async ({ page }) => {
...
test('Always Allow button is visible for fetch requests', async ({ page }) => {
...
test('modal icon shows globe emoji for fetch requests', async ({ page }) => {
...
test('modal title is "Fetch URL"', async ({ page }) => {
...
test('sequential fetch requests each show the correct URL', async ({ page }) => {
...
test('fetch and exec requests queue correctly', async ({ page }) => {

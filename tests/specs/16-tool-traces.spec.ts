...
test('tool_start creates a tool block in the message', async ({ page }) => {
...
test('clicking tool header expands the tool body', async ({ page }) => {
...
test('expanded tool body shows input JSON', async ({ page }) => {
...
test('expanded tool body shows tool output', async ({ page }) => {
...
test('clicking tool header again collapses it', async ({ page }) => {
...
test('expanded tool block adds "expanded" class', async ({ page }) => {
...
test('traces summary shows tool count after a tool turn', async ({ page }) => {
...
test('dispatch_task tool renders as task-block instead of tool-block', async ({ page }) => {

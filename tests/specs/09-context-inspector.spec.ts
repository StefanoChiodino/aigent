...
test.describe('Context Inspector Modal', () => {
  ...
  test('clicking context meter opens inspector', async () => {
    const page = getPage();
    await openInspector(page);
  });

  test('inspector shows summary line with token count', async () => {
    const page = getPage();
    await openInspector(page);
  ...
  test('inspector shows stacked bar', async () => {
    const page = getPage();
    await openInspector(page);
  ...
  test('inspector messages section is present in DOM', async () => {
    const page = getPage();
    await openInspector(page);
  ...
  test('bar rows are expandable on click', async () => {
    const page = getPage();
    await openInspector(page);
  ...
  test('header context meter is also clickable', async () => {
    const page = getPage();

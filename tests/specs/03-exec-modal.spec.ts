...
test('Always Allow button is visible for exec requests', async ({ page }) => {
...
test('sequential exec requests each show the correct command', async ({ page }) => {
...
test('modal icon and title are populated', async ({ page }) => {

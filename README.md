...
AIGENT_LOOP_WINDOW=10             # sliding window size for repetitive tool call detection (default: 10)
AIGENT_LOOP_MAX_REPEATS=5         # max times same tool+args may appear in window before halting (default: 5)
